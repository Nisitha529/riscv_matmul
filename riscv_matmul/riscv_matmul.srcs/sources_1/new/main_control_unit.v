...
module main_control_unit(
  ...
  always @ (*) begin
    case (opcode) 
      ...
      7'b1101111 : {alusrc, memtoreg, regwrite, memread, memwrite, branch, aluop} = {1'b0, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0, 2'b10}; // Jump
      7'b1100111 : {alusrc, memtoreg, regwrite, memread, memwrite, branch, aluop} = {1'b1, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0, 2'b00}; // JALR
      7'b0110111 : {alusrc, memtoreg, regwrite, memread, memwrite, branch, aluop} = {1'b0, 1'b0, 1'b1, 1'b0, 1'b0, 1'b0, 2'b10}; // LUI
