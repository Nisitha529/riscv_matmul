...
module immediate_generator(
  ...
  always @ (*) begin
    case (opcode)
      ...
      7'b1100111 : imm_out = {{20{instruction[31]}}, instruction[31:20]};                                                                 // JALR I-type
      ...
      7'b0110111 : imm_out = {instruction[31:12], 12'b0};                                                                                 // LUI U-type
      7'b0010111 : imm_out = {instruction[31:12], 12'b0};                                                                                 // AUIPC U-type
